...
public sealed class SeoAuditIssue : Entity
{
    private SeoAuditIssue() { }

    public SeoAuditIssue(Guid siteId, Guid contentRecordId, string issueCode, string severity, string title, string description, DateTime utcNow)
    {
        SiteId = siteId;
