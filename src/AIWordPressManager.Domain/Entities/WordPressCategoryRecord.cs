...
public sealed class WordPressCategoryRecord : Entity
{
    private WordPressCategoryRecord() { }

    public WordPressCategoryRecord(Guid siteId, int wordPressId, DateTime utcNow)
    {
        SiteId = siteId;
    ...
    public void Update(string name, string slug, int postCount, DateTime utcNow)
    {
        Name = name;
        Slug = slug;
        PostCount = postCount;
