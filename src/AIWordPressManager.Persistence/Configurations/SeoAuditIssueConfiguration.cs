...
public sealed class SeoAuditIssueConfiguration : IEntityTypeConfiguration<SeoAuditIssue>
{
    public void Configure(EntityTypeBuilder<SeoAuditIssue> builder)
    {
        builder.ToTable("SeoAuditIssues");
